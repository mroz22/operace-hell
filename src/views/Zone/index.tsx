            ...
            return (
                <BunkerCard key={bunker.name}>
                    ...
                    <P>Podpora zivota:</P>
                    {
                        ...
                        :
                        (<span style={{ color: 'red'}}>Chybi. Opustte bunkr</span>)
                    }
                    <P>---</P>
                    ...
                    <P>
                        {
                            countConsumption(bunker) > bunker.oxygenGeneration ?
                               `zbyvajici cas ${(bunker.oxygen / countConsumption(bunker)).toFixed(0)} minut`
                               :
                               `cas do doplneni kysliku ${((bunker.oxygenCap - bunker.oxygen) / (bunker.oxygenGeneration - countConsumption(bunker))).toFixed(0)} minut` 
                        }
                    </P>
                    <P>---</P>
